...
new TypeIt("#teks2", {
  strings: [
    "🌌 Que l’univers te fasse du bien, sous toutes ses formes, visibles ou discrètes.",
    " ",
    "🎉 Joyeux anniversaire, Lise.",
    "🌿 Tu as traversé beaucoup, et tu continues d’exister avec courage, tendresse et vérité.",
    "💛 Merci pour tout ce que tu offres — même quand personne ne le remarque.",
    "🌸 Aujourd’hui, je voulais juste te dire que c’est à ton tour d’être célébrée.",
    " ",
